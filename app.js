...
(function () {
  ...
  const I18N = {
    ar: {
      ...
      homeGuidanceHint: "مهم!",
      step1Title: "  انتبه",
      step1Text: "هذا الموقع خالي من الاعلانات.",
      step2Title: "اخلاء مسؤوليه",
      step2Text: "هذا التطبيق أداة تنظيم ومساعدة للدراسة فقط. استخدامك للتطبيق على مسؤوليتك. لا نضمن عدم فقدان البيانات أو توقف الخدمة، ولا نتحمل مسؤولية أي خسارة أو ضرر ناتج عن مسح بيانات المتصفح، تعطل الجهاز/المتصفح، أو سوء استخدام ميزة الاستيراد/التصدير. يرجى حفظ نسخة احتياطية بشكل دوري. التطبيق لا يقدم ضمان نتائج دراسية ولا يمثل جهة رسمية.",
      step3Title: "الخصوصية",
      step3Text: "هذا التطبيق يحفظ بياناتك محليًا على جهازك داخل المتصفح ولا يرسلها لخوادمنا. قد يتم تحميل خطوط/أيقونات من مزودين خارجيين لتشغيل الواجهة (مثل Google Fonts و unpkg). قد تُفقد البيانات إذا تم مسح بيانات المتصفح أو تغيير الجهاز/المتصفح أو استخدام التصفح الخفي. ننصح بعمل نسخة احتياطية عبر “تصدير كل البيانات” بشكل دوري. لا نستخدم أدوات تتبع أو تحليلات.",
